...
import { getLanguageId, getLanguageName } from './languages.js';
...
export class Judge0Client {
  ...
  async execute({ code, language, stdin = '', timeout = 5, memory = 128000 }) {
    ...
    try {
      ...
      console.log(`[Judge0] Executing ${getLanguageName(languageId)} code...`);
  ...
  async getLanguages() {
    try {
      ...
      console.error('[Judge0] Failed to fetch languages:', error.message);
      return [];
    }
  }
